...
from vnpy_of_python3.examples.vnpy.trader.database import database_manager
...
def extract_hs300_contracts() -> dict:
    all_sotck_contract = down_stock_codes()
    stocks_dict = symbol_to_contract(all_sotck_contract)
